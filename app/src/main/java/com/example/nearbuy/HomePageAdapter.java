...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            ...
            horizontalLayoutTitle = itemView.findViewById(R.id.horizonatal_scroll_layout_title);
    ...
    public class GridProductViewHolder extends RecyclerView.ViewHolder{
        ...
        private void  setGridProductLayout(final List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color){
            ...
            for (int x = 0; x < Math.min(gridProductLayout.getChildCount(), horizontalProductScrollModelList.size()); x++) {
                if (x < horizontalProductScrollModelList.size()) {  // Check size before accessing
                    ...
                    productUrl = gridProductLayout.getChildAt(x).findViewById(R.id.h_s_product_url);
                    ...
                    productUrl.setText(horizontalProductScrollModelList.get(x).getProductUrl());
